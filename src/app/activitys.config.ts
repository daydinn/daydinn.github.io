...
export const ACTIVITYS: Activity[] = [
    ...
    { label: "Movie", description: "Watching films for entertainment or relaxation", img: "/assets/movie32.png", hoveredImg: "/assets/movie32hovered.png", color: "green", points: 1, isHovered: false, isNewActivity: false },
    { label: "Shopping", description: "Purchasing goods or simply browsing stores", img: "/assets/shopping32.png", hoveredImg: "/assets/shopping32hovered.png", color: "blue", points: 1, isHovered: false, isNewActivity: false },
    { label: "Dating", description: "Building connections and seeking relationships", img: "/assets/dating32.png", hoveredImg: "/assets/dating32hovered.png", color: "green", points: 1, isHovered: false, isNewActivity: false },
    { label: "Design", description: "Crafting visuals and creating aesthetics", img: "/assets/design32.png", hoveredImg: "/assets/design32hovered.png", color: "blue", points: 1, isHovered: false, isNewActivity: false },
    { label: "Pilates", description: "A body conditioning routine to build flexibility and muscle strength", img: "/assets/pilates32.png", hoveredImg: "/assets/pilates32hovered.png", color: "red", points: 1, isHovered: false, isNewActivity: false },
